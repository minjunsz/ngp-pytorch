...
from utils.hash_grid_utils import get_voxel_vertices
...
class HashEmbedder(nn.Module):
    def __init__(self, bounding_box, n_levels=16, n_features_per_level=2,\
        ...
        for i in range(n_levels):
            nn.init.uniform_(self.embeddings[i].weight, a=-0.0001, b=0.0001) # type: ignore
    ...
    def forward(self, x):
        ...
        keep_mask = keep_mask.sum(dim=-1)==keep_mask.shape[-1] # type: ignore
